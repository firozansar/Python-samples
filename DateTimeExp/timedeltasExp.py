#
# timedelta objects help with doing calculation on date/time.
# timedelta is a span of time
#
...
if afd < today:
  print ("April Fool's day already went by {0} days ago".format((today-afd).days))
